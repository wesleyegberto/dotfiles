return {
  { 'neovim/nvim-lspconfig',
    ...
    dependencies = {
      ...
      { 'hasansujon786/nvim-navbuddy', dependencies = { 'SmiteshP/nvim-navic', 'MunifTanjim/nui.nvim' } },
      'DNLHC/glance.nvim',
    ...
    config = function()
      ...
      local function setup_keymaps()
        ...
        map('n', 'glt',         ':TestVisit<CR>zz', opts)
      end
      ...
      local function init_lsp_tools()
        ...
        glance.setup({
          border   = { enable = true },
          mappings = { list = { ['l'] = glance.actions.jump } }
        })
      ...
      mason_lsconfig.setup { ensure_installed = servers }
