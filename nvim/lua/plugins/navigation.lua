return {
  { 'nvim-tree/nvim-tree.lua',
    ...
    config = function()
      ...
      require('nvim-tree').setup {
        ...
        view = { side = 'left', width = 50, adaptive_size = false },
        renderer = {
          root_folder_label = function(path) return path:match '[^/]+$' end,
          group_empty = true,
          icons = {
            show = { file = true, folder = true, git = true, folder_arrow = false },
  ...
  { 'junegunn/fzf', build = function() vim.fn['fzf#install']() end, lazy = true },
  { 'junegunn/fzf.vim', cmd = { 'Files', 'GFiles', 'Buffers', 'Rg', 'Lines' } },
  ...
  { 'https://codeberg.org/andyg/leap.nvim',
    config = function() require('leap').opts.safe_labels = '' end },
  ...
  { 'matbme/JABS.nvim',
    ...
    config = function()
      require('jabs').setup {
        ...
        preview = { width = 50, height = 30, border = 'single' },
        keymap = { close = 'd', preview = 'p' }
      }
    end },
