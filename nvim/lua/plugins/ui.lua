return {
  ...
  { 'nvim-lualine/lualine.nvim',
    ...
    config = function()
      local colors = {
        bg       = '#282c34', lightbg  = '#4d5163', yellow   = '#fabd2f',
        cyan     = '#008080', darkblue = '#081633', green    = '#afd700',
        orange   = '#FF8800', purple   = '#5d4d7a', magenta  = '#d16d9e',
        grey     = '#c0c0c0', blue     = '#0087d7', red      = '#ec5f67',
      }
      ...
      require('lualine').setup({
        ...
        sections = {
          ...
          lualine_b = {
            ...
            {
              'diff',
              symbols = { added = '\u{f055} ', modified = '\u{f040} ', removed = '\u{f056} ' },
              diff_color = {
            ...
            },
            {
              ...
              diagnostics_color = {
                error = { fg = colors.red },   warn = { fg = colors.orange },
                info  = { fg = colors.blue },  hint = { fg = colors.green },
              },
  ...
  { dir = '~/projects/github/open-sources/nebula.nvim',
