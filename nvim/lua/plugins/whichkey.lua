...
highlight default link WhichKeyDesc      Operator
      ...
      wk.add({
        ...
        { '<leader>gF',  ':Git fetch --prune<CR>',     desc = 'fetch prune' },
        { '<leader>gk',  ':Git checkout',              desc = 'checkout' },
        ...
        { '<leader>gA',  ':Git amend<CR>',             desc = 'ammend' },
        { '<leader>gM',  ':Git merge',                 desc = 'merge' },
        { '<leader>gP',  ':Git push<CR>',              desc = 'push' },
        { '<leader>gl',  ':Git log<CR>',               desc = 'log' },
        { '<leader>gb',  ':ToggleBlameLine<CR>',       desc = 'blame line' },
        { '<leader>gB',  ':Git blame<CR>',             desc = 'blame view' },
        { '<leader>g/',  ':AdvancedGitSearch<CR>',     desc = 'advanced search' },
        { '<leader>gh',  group = 'Hist' },
        { '<leader>ghl', ':Git hist<CR>',              desc = 'log hist' },
        { '<leader>ghf', ':Git hist %<CR>',            desc = 'file hist' },
      ...
      wk.add({
        { '<leader>R',   group = 'Replace Indent', icon = '󰉿' },
        { '<leader>Rt',  group = 'Spaces → Tab' },
        { '<leader>Rt2', ':set tabstop=2 noexpandtab<CR>:retab!<CR>', desc = '2 spaces → tab' },
        { '<leader>Rt4', ':set tabstop=4 noexpandtab<CR>:retab!<CR>', desc = '4 spaces → tab' },
        { '<leader>Rs',  group = 'Tab → Spaces' },
        { '<leader>Rs2', ':set tabstop=2 expandtab<CR>:retab<CR>',    desc = 'tab → 2 spaces' },
        { '<leader>Rs4', ':set tabstop=4 expandtab<CR>:retab<CR>',    desc = 'tab → 4 spaces' },
      })

      -- Group config for keybindings definied in others plugins
